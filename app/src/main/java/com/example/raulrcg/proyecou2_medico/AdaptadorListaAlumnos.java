...
public class AdaptadorListaAlumnos extends BaseAdapter{
    ...
    public AdaptadorListaAlumnos(Context context, String[] pri,String[] sec){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View itemView = inflater.inflate(R.layout.special_item_alumnos, viewGroup, false);
